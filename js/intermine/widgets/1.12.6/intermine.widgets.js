      ...
      EnrichmentView.prototype.exportAction = function(e) {
        ...
        return this.widget.queryRows(pq, function(response) {
          ...
          for (_k = 0, _len2 = selected.length; _k < _len2; _k++) {
            model = selected[_k];
            result.push([model.get('identifier'), model.get('description'), model.get('p-value')].join("\t") + "\t" + dict[model.get('identifier')].join(','));
          }
          if (result.length) {
            try {
  ...
  Widgets = (function() {
    ...
    Widgets.prototype.resources = {
      ...
      'js': {
        ...
        'jQuery': {
          'path': 'https://phytozome.jgi.doe.gov/intermine/cdn/js/jquery/1.9.1/jquery-1.9.1.min.js'
        },
        '_': {
          'path': 'https://phytozome.jgi.doe.gov/intermine/cdn/js/underscore.js/1.3.3/underscore-min.js'
        },
        'Backbone': {
          'path': 'https://phytozome.jgi.doe.gov/intermine/cdn/js/backbone.js/1.0.0/backbone-min.js',
          'depends': ['jQuery', '_']
        },
        'google': {
        ...
        'intermine.imjs': {
          'path': 'https://phytozome.jgi.doe.gov/intermine/cdn/js/intermine/imjs/2.6.0/im.js',
          'depends': ['jQuery', '_']
        },
        'FileSaver': {
