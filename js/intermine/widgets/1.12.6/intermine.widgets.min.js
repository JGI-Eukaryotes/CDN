...
"_"]},google:{path:"https://www.google.com/jsapi"},"intermine.imjs":{path:"https://phytozome.jgi.doe.gov/intermine/cdn/js/intermine/imjs/2.6.0/im.js",depends:["jQuery","_"]},FileSaver:{path:"http://cdn.intermine.org/js/filesaver.js/FileSaver.min.js"}}};m.prototype.chart=function(){var a,b,d=this;a=1<=arguments.length?p.call(arguments,0):[];return(b=function(){return d.wait?setTimeout(b,20):google.load("visualization","1.0",{packages:["corechart"],callback:function(){var b=A.ChartWidget,e=[d.service,d.token].concat(p.call(a)),
